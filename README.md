...
> ⚠️&nbsp; The official `.nl` mirror is disabled until further notice due to Cloudflare protection forbidding the plugin from accessing it. See [#41](https://github.com/nbusseneau/qBittorrent-RuTracker-plugin/issues/41#issuecomment-1064665073) for more details and discussion.
